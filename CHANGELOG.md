...
### Changed
- **Web Long Poll** как на vk.ru: `messages.getDiff` → credentials → `api.vk.ru/ruim{user_id}`
- API: `web.api.vk.ru` + client_id=6287487 + Bearer
- Bootstrap validates via getDiff; intercepts web_token / Bearer
